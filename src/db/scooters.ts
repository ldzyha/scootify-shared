...
export const hyperScooters: Scooter[] = [
  // Teverun Fighter Mini - unique to hiley
  {
    ...
    shortDescription: 'Compact high-performance scooter with 2000W power and 65 km/h top speed',
  ...
  // Teverun Blade GT 2+ - unique to hiley
  {
    ...
    shortDescription: 'High-performance scooter with 4900W power and 85 km/h top speed',
  ...
  // Nami Burn-E 3 Max - unique to hiley (DIFFERENT from Burn-E MAX)
  {
    ...
    shortDescription: 'High-performance scooter with 8400W power, 100 km/h speed, and large display',
    ...
    domains: ['hysco.com.ua'],
    media: {
      images: ['/products/hyper/nami-burn-e3-max.webp'],
      videos: [],
      youtubeIds: [],
    },
    seo: {
  ...
  // Nanrobot LS7+ - unique to hiley
  {
    ...
    name: 'Nanrobot LS7+',
    nameUk: 'Nanrobot LS7+',
    shortDescription: 'High-performance scooter with 7000W power and 100 km/h top speed',
...
export const tigerScooters: Scooter[] = [
{
    ...
    shortDescription: 'Флагманський самокат з 11-дюймовими колесами та гідравлічною підвіскою. Два мотори з піковою потужністю {totalPower}W розганяють до {maxSpeed} км/год та забезпечують {range} км запасу ходу.',
    shortDescriptionUk: 'Флагманський самокат з 11-дюймовими колесами та гідравлічною підвіскою. Два мотори з піковою потужністю {totalPower}W розганяють до {maxSpeed} км/год та забезпечують {range} км запасу ходу.',
...

{
    ...
    name: 'Tiger SUPRA',
    nameUk: 'Tiger SUPRA',
    shortDescription: 'Преміальний самокат з двомоторною системою та гідропідвіскою. Пікова потужність {totalPower}W дозволяє досягати {maxSpeed} км/год з запасом ходу {range} км.',
    shortDescriptionUk: 'Преміальний самокат з двомоторною системою та гідропідвіскою. Пікова потужність {totalPower}W дозволяє досягати {maxSpeed} км/год з запасом ходу {range} км.',
...

{
    ...
    name: 'Tiger 10 GTR',
    nameUk: 'Tiger 10 GTR',
    shortDescription: 'Спортивний GTR з водозахистом IPX7. Два мотори з піковою потужністю {totalPower}W забезпечують {maxSpeed} км/год та {range} км запасу.',
    shortDescriptionUk: 'Спортивний GTR з водозахистом IPX7. Два мотори з піковою потужністю {totalPower}W забезпечують {maxSpeed} км/год та {range} км запасу.',
...

{
    ...
    shortDescription: 'Рекордсмен за запасом ходу — проїдьте {range} км на одному заряді. Два мотори {totalPower}W розганяють до {maxSpeed} км/год.',
    shortDescriptionUk: 'Рекордсмен за запасом ходу — проїдьте {range} км на одному заряді. Два мотори {totalPower}W розганяють до {maxSpeed} км/год.',
...

{
    ...
    name: 'Tiger 10 GT',
    nameUk: 'Tiger 10 GT',
    shortDescription: 'Оптимальне співвідношення ціни та динаміки з двома моторами. Пікова потужність {totalPower}W, швидкість до {maxSpeed} км/год, запас {range} км.',
    shortDescriptionUk: 'Оптимальне співвідношення ціни та динаміки з двома моторами. Пікова потужність {totalPower}W, швидкість до {maxSpeed} км/год, запас {range} км.',
...

{
    ...
    shortDescription: 'Батарея на преміальних елементах Samsung 21700 та швидкознімні шини. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    shortDescriptionUk: 'Батарея на преміальних елементах Samsung 21700 та швидкознімні шини. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
...

{
    ...
    shortDescription: 'Long Range для тих, хто їздить далеко — {range} км вистачає на тиждень. Два мотори {totalPower}W, {maxSpeed} км/год.',
    shortDescriptionUk: 'Long Range для тих, хто їздить далеко — {range} км вистачає на тиждень. Два мотори {totalPower}W, {maxSpeed} км/год.',
...

{
    ...
    name: 'Tiger 10 V4',
    nameUk: 'Tiger 10 V4',
    shortDescription: 'Доступний вхід у світ Tiger 10 з повним водозахистом IPX7. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    shortDescriptionUk: 'Доступний вхід у світ Tiger 10 з повним водозахистом IPX7. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    ...
    media: {
      images: [
        '/products/tiger-10-v4/main.webp',
...

{
    ...
    name: 'Tiger 10 V5',
    nameUk: 'Tiger 10 V5',
    shortDescription: 'Нове покоління з подвійною зарядкою та швидкознімними шинами. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    shortDescriptionUk: 'Нове покоління з подвійною зарядкою та швидкознімними шинами. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
...

{
    ...
    shortDescription: 'Лідер серії EVO з подвійною зарядкою та яскравим дизайном. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    shortDescriptionUk: 'Лідер серії EVO з подвійною зарядкою та яскравим дизайном. Два мотори {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
...

{
    ...
    shortDescription: 'Двомоторний самокат за ціною одномоторних моделей. Пікова потужність {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    shortDescriptionUk: 'Двомоторний самокат за ціною одномоторних моделей. Пікова потужність {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
...

{
    ...
    name: 'Tiger EVO GT',
    nameUk: 'Tiger EVO GT',
    shortDescription: 'Чемпіон з енергоефективності — {range} км при вазі лише {weight} кг. Мотор {totalPower}W, швидкість {maxSpeed} км/год.',
    shortDescriptionUk: 'Чемпіон з енергоефективності — {range} км при вазі лише {weight} кг. Мотор {totalPower}W, швидкість {maxSpeed} км/год.',
...

{
    ...
    shortDescription: 'Компактний 8.5-дюймовий самокат з двома моторами, ідеальний для міста. Потужність {totalPower}W, {maxSpeed} км/год, {range} км.',
    shortDescriptionUk: 'Компактний 8.5-дюймовий самокат з двома моторами, ідеальний для міста. Потужність {totalPower}W, {maxSpeed} км/год, {range} км.',
...

{
    ...
    name: 'Tiger MAX GT',
    nameUk: 'Tiger MAX GT',
    shortDescription: 'Легкий та надійний самокат для щоденних поїздок — всього {weight} кг. Мотор {totalPower}W, {maxSpeed} км/год, {range} км.',
    shortDescriptionUk: 'Легкий та надійний самокат для щоденних поїздок — всього {weight} кг. Мотор {totalPower}W, {maxSpeed} км/год, {range} км.',
...

{
    ...
    name: 'Tiger EVO',
    nameUk: 'Tiger EVO',
    shortDescription: 'Ідеальний старт у світ Tiger з повним водозахистом IPX7. Мотор {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
    shortDescriptionUk: 'Ідеальний старт у світ Tiger з повним водозахистом IPX7. Мотор {totalPower}W, {maxSpeed} км/год, {range} км запасу.',
...

{
    ...
    priceUsdCents: 259100,
    originalPriceUsdCents: 323900,
    costUsdCents: null,
    availability: 'pre_order',
    purchaseModel: 'consultation',
    stockQuantity: null,
...
export const kaaboScooters: Scooter[] = [
{
    ...
    specs: {
      ...
      shipping: {
        ...
        cargoDescription: 'Електросамокат Електросамокат Kaabo Wolf King GTR Серія (GTR / GTR Max)',
        cargoType: null
      }
    },
    variants: [],
...

{
    ...
    specs: {
      ...
      shipping: {
        ...
        cargoDescription: 'Електросамокат Електросамокат Kaabo Wolf Warrior 11 Plus',
        cargoType: null
      }
    },
    variants: [],
...

{
    ...
    specs: {
      ...
      shipping: {
        ...
        cargoDescription: 'Електросамокат Електросамокат Kaabo Wolf Warrior X Pro+',
        cargoType: null
      }
    },
    variants: [],
...

{
    ...
    specs: {
      ...
      shipping: {
        ...
        cargoDescription: 'Електросамокат Електросамокат Kaabo Wolf Warrior X Plus',
        cargoType: null
      }
    },
    variants: [],
...

{
    ...
    specs: {
      ...
      shipping: {
        ...
        cargoDescription: 'Електросамокат Електросамокат Kaabo Mantis King GT',
        cargoType: null
      }
    },
    variants: [],
...

{
    ...
    specs: {
      ...
      shipping: {
        ...
        cargoDescription: 'Електросамокат Електросамокат Kaabo Mantis 10 Plus',
        cargoType: null
      }
    },
    variants: [],
