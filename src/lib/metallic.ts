...
export const metallicBase = {
  ...
  silver:
    "linear-gradient(135deg, #a0a0a0 0%, #d0d0d0 20%, #f5f5f5 40%, #ffffff 50%, #f5f5f5 60%, #d0d0d0 80%, #a0a0a0 100%)",
  // Platinum: medium brightness, good contrast
  platinum:
    "linear-gradient(135deg, #707070 0%, #909090 20%, #b8b8b8 40%, #d0d0d0 50%, #b8b8b8 60%, #909090 80%, #707070 100%)",
  ...
  green:
    "linear-gradient(135deg, #2a6c2a 0%, #409040 20%, #60b060 40%, #80d080 50%, #60b060 60%, #409040 80%, #2a6c2a 100%)",
} as const;
...
export const metallicSubtle = {
  silver:
    "linear-gradient(135deg, rgba(160, 160, 160, 0.1) 0%, rgba(220, 220, 220, 0.08) 50%, rgba(160, 160, 160, 0.1) 100%)",
  ...
  green:
    "linear-gradient(135deg, rgba(42, 108, 42, 0.2) 0%, rgba(96, 176, 96, 0.1) 50%, rgba(42, 108, 42, 0.2) 100%)",
} as const;
 ...
 */
export const siteMetallics: Record<
  ThemeId,
  ReturnType<typeof createMetallicPalette>
> = {
  ...
  scoo: createMetallicPalette(
    "linear-gradient(90deg, #0d9488 0%, #14b8a6 50%, #2dd4bf 100%)",
    "linear-gradient(90deg, #14b8a6 0%, #2dd4bf 25%, #5eead4 50%, #2dd4bf 75%, #14b8a6 100%)",
    "simple",
  ),
};
