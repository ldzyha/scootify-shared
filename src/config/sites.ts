...
export const hileyConfig: SiteConfig = {
  ...
  description:
    "Офіційний постачальник преміум електросамокатів HILEY Tiger в Україні",
  contact: {
...
export const scooConfig: SiteConfig = {
  siteName: "SCOO",
  siteUrl: "https://scoo.com.ua",
  domain: "scoo.com.ua",
  brand: "SCOO",
  ...
  theme: { id: "scoo" },
  metallicGradients: {
    brandBg: siteMetallics.scoo.brandBg,
    brandText: siteMetallics.scoo.brandText,
  },
  defaultCurrency: "UAH",
  fallbackExchangeRate: 43.5,
  productUrlPattern: "/product/:slug",
